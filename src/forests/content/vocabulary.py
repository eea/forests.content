...
from .constants import (ACCESSIBILITY_LEVELS, DATA_SOURCES, DATASETS,
                        GEOCOVERAGE_REGIONS, INFO_LEVELS, NUTS_LEVELS,
                        RESOURCE_TYPES)
...
info_levels_vocabulary = generic_vocabulary(INFO_LEVELS)
alsoProvides(info_levels_vocabulary, IVocabularyFactory)
